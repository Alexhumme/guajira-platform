...
const exportTables = [
  ...
  { name: 'asociaciones', query: 'SELECT * FROM asociacion ORDER BY nombre' },
  { name: 'asociacion_comunidad', query: 'SELECT * FROM asociacion_comunidad ORDER BY id_asociacion_comunidad' },
  { name: 'miembros', query: 'SELECT * FROM miembro ORDER BY id_miembro' },
  { name: 'miembros_representantes', query: 'SELECT * FROM miembro_representante ORDER BY id_miembro_representante' },
  { name: 'redes_asociacion', query: 'SELECT * FROM red_asociacion ORDER BY id_red_asociacion' },
